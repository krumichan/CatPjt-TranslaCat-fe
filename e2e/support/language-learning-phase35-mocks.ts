...
export const LEVEL_TEST_SPEAKING_OPEN = {
    ...
    instruction: "与えられた条件に従って、日本語で話してください。",
    promptText: "友達に予定の変更を提案し、木曜日の夜が都合よいか尋ねてください。",
    taskGuidance: {
        providedFacts: ["来週火曜日の夜は参加できない", "木曜日の夜なら参加できる"],
        requiredIntents: ["予定変更を提案する", "相手の都合を確認する"],
        responseConstraints: ["日本語で2～4文程度"],
    },
    referenceAudioAvailable: false,
    repeatReferenceText: null,
    referencePlaybackLimit: null,
    ...
    items: [
        {
            ...
            itemType: "VOCAB_CONTEXT_CHOICE",
            complexityBand: 4,
            instruction: LEVEL_TEST_QUESTION.instruction,
            promptText: LEVEL_TEST_QUESTION.promptText,
            options: LEVEL_TEST_QUESTION.options,
            emphasisText: null,
            taskGuidance: null,
            selectedOptionKey: "B",
            selectedOptionKeys: [],
            ...
            answerAudioAvailable: false,
            referenceAudioAvailable: false,
            transcript: null,
            recommendedAnswers: [],
            detailedFeedback: [],
            modelAnswerAudioAvailable: false,
            correctOptionKey: "A",
            correctOrder: [],
            evaluable: true,
            score: 0,
        ...
        },
        {
            ...
            itemType: "SPEAKING_REPEAT",
            complexityBand: 4,
            instruction: LEVEL_TEST_SPEAKING.instruction,
            ...
            textAnswer: null,
            audioSubmitted: true,
            answerAudioAvailable: true,
            referenceAudioAvailable: true,
            transcript: "予定を変更する場合は、早めに連絡してください。",
            recommendedAnswers: ["予定を変更する場合は、できるだけ早く相手に連絡してください。"],
            detailedFeedback: [],
            modelAnswerAudioAvailable: true,
