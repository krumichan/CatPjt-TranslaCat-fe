    ...
    return (
        <div className="mt-2 space-y-1">
            {visibleTranslations.map((translation) => {
                const translatedContent = translation.translatedContent?.trim() ?? "";

                return (
                    <div
                        key={`${translation.languageCode}-${translation.status}-${translation.id}`}
                    ...
                    >
                        ...
                        {translation.status === "COMPLETED" && translatedContent && (
