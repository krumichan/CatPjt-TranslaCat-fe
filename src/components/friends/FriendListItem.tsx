...
import { Check, MessageCircle, MoreVertical, UserRound } from "lucide-react";
                ...
                <div className="flex min-w-0 items-center gap-3">
                    {isGroupSelectionMode && (
                        <button
                            ...
                            className={`flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl border text-sm font-black transition ${
                                isSelected
                ...
                <div className="flex shrink-0 items-center gap-2">
                    ...
                    <div className="relative">
                        <button
                            ...
                            className="flex h-11 w-11 items-center justify-center rounded-2xl bg-white text-slate-500 ring-1 ring-slate-200 transition hover:bg-slate-100 hover:text-slate-900 dark:bg-white/10 dark:text-slate-300 dark:ring-white/10 dark:hover:bg-white/15 dark:hover:text-white"
                        >
                            <MoreVertical
                                className="h-5 w-5"
                                aria-hidden="true"
