...
export function SpeakingHistoryDetail({
    ...
    const assistanceT = useTranslations(
        "LanguageLearning.speaking.session.assistance",
    );
    ...
    return (
        <div className="space-y-5" data-testid="speaking-history-detail">
            ...
            <section className="rounded-2xl border border-slate-200 bg-white p-5 dark:border-white/10 dark:bg-slate-900">
                ...
                <p className="mt-1 text-xs leading-5 text-slate-500 dark:text-slate-400">
                    {t("assistanceSummaryDescription", {
                        count: assistanceUsage.length,
                    })}
                </p>
            ...
            <section className="space-y-3">
                ...
                {detail.turns.map((turn) => (
                    ...
                    >
                        ...
                        <div className="mt-2">
                            {turn.userAudioUrl ? (
                                <AudioPlaybackButton url={turn.userAudioUrl} />
                            ) : (
