...
import { BookOpen, Ear, MessageCircleMore, PencilLine } from "lucide-react";
        ...
        <aside className="rounded-3xl border border-slate-200 bg-white/90 p-4 shadow-sm dark:border-white/10 dark:bg-slate-900/75">
            ...
            <div className="mt-3 max-h-[70vh] space-y-2 overflow-y-auto">
                {controller.items.map((item) => {
                    ...
                    const Icon = item.source === "SPEAKING" ? MessageCircleMore : item.source === "LISTENING" ? Ear : item.source === "READING" ? BookOpen : PencilLine;
                    return (
